module.exports = {
  creds: {
    // Required
    identityMetadata:
      'https://login.microsoftonline.com/b6fd9e93-8e13-4460-9543-19b436c21535/v2.0/.well-known/openid-configuration',
    // 'https://login.microsoftonline.com/yaroslavtereshchuk@gmail.com.onmicrosoft.com/v2.0/.well-known/openid-configuration',
    // 'https://login.microsoftonline.com/yaroslavtereshchuk@gmail.com/v2.0/.well-known/openid-configuration',
    ...
    clientID: '00132e29-2169-4da2-a4b2-c9f6fbc032ad',
    ...
    clientSecret: 'ULw1F_oQNftwHy1~RSj9lSm~YVN_C89er.',
  ...
  destroySessionUrl:
    'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=http://localhost:3000/auth/openid/return',
